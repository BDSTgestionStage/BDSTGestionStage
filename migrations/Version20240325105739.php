 ...
 */
final class Version20240325105739 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entreprise (id INT AUTO_INCREMENT NOT NULL, ent_nom VARCHAR(255) NOT NULL, ent_ville VARCHAR(255) NOT NULL, ent_pays VARCHAR(255) DEFAULT NULL, ent_specialite VARCHAR(255) DEFAULT NULL, ent_adresse VARCHAR(255) NOT NULL, ent_cp VARCHAR(5) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
